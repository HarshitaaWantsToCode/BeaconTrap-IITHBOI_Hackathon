  ...
  return (
    <div className="space-y-6 font-mono">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Compliance Meter */}
        <div className="bg-[var(--bg-panel-alt)] border border-[var(--border)] p-5 rounded-sm flex flex-col justify-between items-center text-center">
          ...
          <div className="w-full p-2.5 rounded-sm bg-[var(--bg-panel)] border border-[var(--border)] flex items-center justify-between text-xs font-mono">
        ...
        <div className="lg:col-span-2 bg-[var(--bg-panel-alt)] border border-[var(--border)] p-5 rounded-sm flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-[10px] font-mono px-2 py-0.5 rounded-sm bg-[var(--severity-critical)]/10 text-[var(--severity-critical)] font-bold border border-[var(--severity-critical)]/30">
                6-HOUR MANDATORY SLA WARNING
              </span>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-xs mb-4">
              <div className="p-3 bg-[var(--bg-panel)] border border-[var(--border)] rounded-sm space-y-1">
          ...
          <div className="p-3 bg-[var(--severity-critical)]/10 border border-[var(--severity-critical)]/30 rounded-sm text-xs font-mono text-[var(--severity-critical)] flex items-center justify-between">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-sans">
          {/* RBI Mandate Card */}
          <div className="bg-[var(--bg-panel-alt)] border border-[var(--border)] p-4 rounded-sm flex flex-col justify-between space-y-3">
            <div>
          ...
          <div className="bg-[var(--bg-panel-alt)] border border-[var(--border)] p-4 rounded-sm flex flex-col justify-between space-y-3">
            <div>
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[10px] font-mono px-2 py-0.5 rounded-sm bg-[var(--severity-medium)]/10 text-[var(--severity-medium)] font-bold border border-[var(--severity-medium)]/30">
                  Statutory Offence
                </span>
              </div>
