    ...
    <div className="flex flex-col h-full gap-3">
            ...
            return (
              <React.Fragment key={stage.id}>
                ...
                >
                  ...
                  {/* Phase Header */}
                  <div
                    className="relative w-full rounded-lg border p-2.5 text-center transition-all duration-200"
                    style={{
                  ...
                  >
                    ...
                    {isHovered && (
                      <div
                        className="absolute top-full left-1/2 -translate-x-1/2 mt-2 z-50 w-44 rounded-lg border p-2 space-y-1 shadow-2xl"
                        style={{
      ...
      <div className="flex items-center gap-4 pt-1 border-t border-slate-800/60">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[9px] font-mono text-slate-500 uppercase">Detected Stage</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="w-2 h-2 rounded-full bg-slate-700" />
          <span className="text-[9px] font-mono text-slate-500 uppercase">Unconfirmed</span>
        </div>
        <div className="ml-auto text-[9px] font-mono text-slate-600 uppercase tracking-widest">
      ...
      <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-6 backdrop-blur-md">
        ...
        <div className="h-64">
          {hasTrend ? (
                ...
                <Tooltip
                  content={({ active, payload }) => {
                    if (active && payload && payload.length) {
                      ...
                      return (
                        <div className="bg-slate-950 border border-slate-800 rounded-lg p-3 shadow-lg">
                          <p className="text-[10px] text-slate-500 font-mono">{data.date}</p>
            ...
            <span className="text-xs text-slate-500">No logs found.</span>
          )}
        </div>
      </div>
    </div>
