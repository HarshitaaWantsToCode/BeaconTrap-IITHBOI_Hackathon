    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/70 backdrop-blur-md p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl rounded-2xl border border-card-border bg-card p-6 shadow-2xl space-y-6 font-sans text-text-primary">
          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 rounded-lg border font-bold transition-all cursor-pointer ${
                  isSelected
        ...
        <div className="flex justify-end gap-3 pt-2 font-mono text-xs">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-lg bg-card-bg-secondary hover:bg-card-border text-text-primary font-bold border border-card-border cursor-pointer transition-all"
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            className="px-4 py-2 rounded-lg bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-300 border border-cyan-500/40 font-bold flex items-center gap-2 cursor-pointer transition-all shadow-[0_0_15px_rgba(6,182,212,0.2)]"
          >
