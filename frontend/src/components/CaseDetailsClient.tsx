    ...
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-card-border pb-5 no-print">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handlePrint}
            className="flex items-center gap-2 border border-card-border hover:border-primary/50 bg-card-secondary text-text-secondary font-semibold px-4 py-2 rounded-lg text-xs tracking-wider uppercase transition-all duration-200"
          >
      ...
      <div className="bg-card border border-card-border rounded-xl p-6 backdrop-blur-md relative overflow-hidden" style={{ boxShadow: "var(--shadow-card)" }}>
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3.5 pt-2 font-mono text-xs">
            {/* Fraud risks */}
            <div className="bg-card-secondary border border-card-border p-3.5 rounded-lg flex flex-col justify-between">
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 text-xs font-semibold uppercase tracking-wider border rounded-lg transition-all duration-200 shrink-0 ${isSelected ? "bg-primary/10 text-primary border-primary/40 shadow-sm" : "bg-transparent border-transparent text-text-secondary hover:text-text-primary hover:bg-primary/10"}`}
                  >
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div className="border-t border-card-border/60 pt-6 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono">
                      {/* Permissions List */}
                      <div className="bg-card-secondary border border-card-border rounded-lg p-4 space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {mitreTags.length > 0 ? (
                        mitreTags.map((tag) => (
                          <div
                            key={tag.id}
                            className="bg-card-secondary border border-card-border px-3 py-1.5 rounded-lg flex items-center gap-2"
                          >
                      ...
                      {iocs.length > 0 ? (
                        iocs.map((ioc, idx) => {
                          ...
                          return (
                            <div
                              key={idx}
                              className="p-3 bg-card border border-card-border rounded-lg flex items-center justify-between"
                            >
                        ...
                        <div className="p-4 bg-card-secondary border border-card-border rounded-lg text-center text-xs text-text-muted italic">
              ...
              {activeTab === "summary" && (
                <div className="space-y-6 animate-fadeIn">
                  {loadingExecSummary ? (
                    ...
                    <div className="p-6 bg-[var(--critical-bg)] border border-[var(--critical-border)] rounded-lg text-center space-y-2">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-card-secondary border border-card-border p-4.5 rounded-lg space-y-2">
                      ...
                      <div className="bg-card-secondary border border-card-border p-4.5 rounded-lg space-y-3">
                        <h5 className="text-[10px] font-mono text-primary uppercase tracking-widest font-bold">
                    ...
                    <div className="p-6 bg-card-secondary border border-card-border rounded-lg text-center text-xs text-text-muted italic">
                      No summary compiled.
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div className="bg-card-secondary border border-card-border p-5 rounded-lg space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="bg-card border border-card-border rounded-lg p-3.5 text-center">
                  ...
                  <div className="border-t border-card-border pt-6 space-y-4">
                    ...
                    <div className="space-y-4">
                      {multilingualReports[language] ? (
                        ...
                        <div className="p-5 bg-card-secondary border border-card-border rounded-lg text-center text-xs text-text-muted italic">
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-xs font-mono">
                    <div className="space-y-1.5">
                      ...
                      <p className="text-text-secondary break-all text-[11px] bg-card-secondary p-3 rounded-lg border border-card-border leading-relaxed font-bold">
                        {caseData.sha256}
                      </p>
                    </div>
                    ...
                    <div className="space-y-1 bg-card-secondary p-4 rounded-lg border border-card-border">
                  ...
                  <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg text-text-secondary font-sans text-xs leading-relaxed">
                  ...
                  <div className="border-t border-card-border pt-6 space-y-4">
                    ...
                    <div className="space-y-3">
                      {grcData.regulatoryClauses.map((clause, idx) => {
                        ...
                        return (
                          <div key={idx} className="bg-card border border-card-border p-4 rounded-lg flex flex-col md:flex-row md:items-start justify-between gap-4">
                  ...
                  <div className="border-t border-card-border pt-6 space-y-4">
                    ...
                    <div className="max-h-[350px] overflow-y-auto space-y-2.5 pr-1 text-xs font-mono">
                      {[
                        ...
                        return (
                          <div key={idx} className="p-3.5 bg-card border border-card-border rounded-lg flex flex-col md:flex-row md:items-center justify-between gap-3 font-mono text-xs">
          ...
          <div className="bg-card border-b border-card-border px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="p-1.5 rounded-lg border border-card-border hover:border-primary/50 bg-card-secondary hover:bg-primary/5 text-text-secondary hover:text-text-primary transition-colors"
              >
              ...
              <div className="p-5 border-b border-card-border space-y-4 shrink-0">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full h-1 bg-card border border-card-border rounded-lg appearance-none cursor-pointer accent-primary"
                  />
                  ...
                  {processedNodes.map((node) => {
                    ...
                    return (
                      <div
                        ...
                        className={`p-2.5 rounded-lg border bg-card transition-all hover:bg-primary/5 cursor-pointer ${
